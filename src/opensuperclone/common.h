...
extern struct passthrough_t passthrough_ccc;
...
*/
struct __attribute__((packed)) driver_control_data_t
{
  int64_t command;
...
extern struct driver_control_data_t driver_control_data_ccc;
...
extern char model_ccc[MAX_DEVICES][256];
...
extern struct ncq_error_log_data_t ncq_error_log_data_ccc;

struct rebuild_assist_log_data_t
{
  unsigned char flags;
...
extern struct rebuild_assist_log_data_t rebuild_assist_log_data_ccc;
