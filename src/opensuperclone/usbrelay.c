...
int choose_usb_device_ccc(void)
{
  ...
  {
    snprintf(tempmessage_ccc, TEMP_MESSAGE_SIZE, "Error: USB device is not mass storage.\n");
...
int usb_get_max_lun_ccc(int timeout)
{
  if (superclone_ccc)
  {
    snprintf(tempmessage_ccc, TEMP_MESSAGE_SIZE, "usb get max lun\n");
...
int usb_bulk_only_reset_ccc(int timeout)
{
  if (superclone_ccc)
  {
    snprintf(tempmessage_ccc, TEMP_MESSAGE_SIZE, "usb bulk reset\n");
    message_console_log_ccc(tempmessage_ccc, 0);
  }
...
int do_usb_reset_ccc(void)
{
  if (superclone_ccc)
  {
    snprintf(tempmessage_ccc, TEMP_MESSAGE_SIZE, "usb port reset\n");
    message_console_log_ccc(tempmessage_ccc, 0);
  }
  int ret = 0;
